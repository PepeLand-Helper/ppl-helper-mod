...
public class ChatFiltersScreen {
    ...
    public Screen build(Screen parent){
        ...
        builder.addWidget(new TextBuilder(Component.translatable("pplhelper.chat_filters")))
                ...
                .addWidget(new EditBoxBuilder(Component.translatable("pplhelper.chat_filters.nwords")).setValue("").setConfig(PepelandHelper.config, "CHAT.FILTER.WORDS"));
